...
onload = function() {
	...
	ele = document.getElementById('challenge1');
	zoneChallenges1 = new ClsConversations2('zoneChallenges1',eVideo,ele,htmlChallenges1);
	zoneChallenges1.draw();

	ele = document.getElementById('challenge2');
	zoneChallenges2 = new ClsConversations2('zoneChallenges2',eVideo,ele,htmlChallenges2);
	zoneChallenges2.draw();
